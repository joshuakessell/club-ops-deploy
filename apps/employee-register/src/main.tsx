...
import './styles.required-tender.css';
...
import './styles.components.signin-modal.css';
import './styles.components.effects.css';
import './styles.components.offer-upgrade.css';
import './styles.components.orientation.css';
import './styles.navigation.css';
import './styles.notifications.css';
import './styles.modals.css';
import './styles.register.shell.css';
import './styles.register.checkout.css';
import './styles.register.upgrades.css';
import './styles.register.account.css';
import './styles.register.assist.css';
