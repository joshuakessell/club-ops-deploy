-- Redundancy scan annotations
-- Result: No redundant/no-op statements detected for the requested categories.
-- Categories checked: CREATE INDEX then DROP INDEX, ALTER TABLE collapses, add-then-alter columns,
-- constraints that are never referenced within this migration.
-- Notes: This is a squashed baseline snapshot; it primarily contains CREATE/ALTER/INDEX/CONSTRAINT statements.
